...
class Tile:
    def __init__(self, color1,color2,win):
    ...
    def drawTile(self,pt1,pt2):
        ...
        self.half1 = Rectangle(Point(rectX1+3,rectY1-3),Point(rectX1+47,rectY1-47))
        self.half1.draw(self.win)
        self.half1.setFill(self.color1)
        self.half1.setOutline('brown')
        self.objects.append(self.half1)
        self.half2 = Rectangle(Point(rectX2-3,rectY2+3),Point(rectX2-47,rectY2+47))
        self.half2.draw(self.win)
